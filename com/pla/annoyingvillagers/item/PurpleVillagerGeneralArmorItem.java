...
/*     */ 
/*     */ public abstract class PurpleVillagerGeneralArmorItem
/*     */   extends ArmorItem {
/*     */   public PurpleVillagerGeneralArmorItem(ArmorItem.Type type, Item.Properties properties) {
/*  28 */     super(new ArmorMaterial()
/*     */         {
/*     */           public int m_266425_(ArmorItem.Type type) {
/*     */             // Byte code:
/*     */             //   0: getstatic com/pla/annoyingvillagers/item/PurpleVillagerGeneralArmorItem$2.$SwitchMap$net$minecraft$world$item$ArmorItem$Type : [I
/*     */             //   3: aload_1
...
/*     */             //   0	70	0	this	Lcom/pla/annoyingvillagers/item/PurpleVillagerGeneralArmorItem$1;
...
/*     */             // Local variable table:
/*     */             //   start	length	slot	name	descriptor
/*     */             //   0	64	0	this	Lcom/pla/annoyingvillagers/item/PurpleVillagerGeneralArmorItem$1;
...
/*     */     extends PurpleVillagerGeneralArmorItem {
/*     */     public Helmet() {
/*  90 */       super(ArmorItem.Type.HELMET, new Item.Properties());
/*     */     }
/*     */     
/*     */     public void initializeClient(Consumer<IClientItemExtensions> consumer) {
/*  94 */       consumer.accept(new IClientItemExtensions() {
/*     */             @NotNull
/*     */             public HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack, EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
/*  97 */               HumanoidModel<?> humanoidmodel1 = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("head", (new ModelVillagerGeneralArmor(Minecraft.m_91087_().m_167973_().m_171103_(ModelVillagerGeneralArmor.LAYER_LOCATION))).Head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "body", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "right_arm", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "left_arm", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "right_leg", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "left_leg", new ModelPart(Collections.emptyList(), Collections.emptyMap()))));
/*     */               
/*  99 */               humanoidmodel1.f_102817_ = livingEntity.m_6144_();
/* 100 */               humanoidmodel1.f_102609_ = original.f_102609_;
/* 101 */               humanoidmodel1.f_102610_ = livingEntity.m_6162_();
/* 102 */               return humanoidmodel1;
/*     */             }
/*     */           });
/*     */     }
/*     */     
/*     */     public String getArmorTexture(ItemStack itemstack, Entity entity, EquipmentSlot equipmentslot, String s) {
/* 108 */       return "annoyingvillagers:textures/entities/purple.png";
/*     */     }
/*     */   }
/*     */   
...
/* Location:              C:\Users\Aours\AppData\Roaming\PrismLauncher\instances\1.20.1 remake\minecraft\mods\AnnoyingVillagers-1.20.1-1.4.5.jar!\com\pla\annoyingvillagers\item\PurpleVillagerGeneralArmorItem.class
