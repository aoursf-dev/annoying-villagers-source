...
/* 19 */     return new SparkParticleProvider(spriteset);
/*    */   }
/*    */   
...
/* 26 */     this.f_107663_ *= 0.25F;
/* 27 */     this.f_107225_ = Math.max(1, 23 + this.f_107223_.m_188503_(20) - 10);
/* 28 */     this.f_107226_ = 0.5F;
...
/*    */   }
/*    */   
/*    */   public static class SparkParticleProvider
...
/* 57 */       return (Particle)new SparkParticle(clientlevel, d0, d1, d2, d3, d4, d5, this.spriteSet);
/*    */     }
/*    */   }
/*    */ }


/* Location:              C:\Users\Aours\AppData\Roaming\PrismLauncher\instances\1.20.1 remake\minecraft\mods\AnnoyingVillagers-1.20.1-1.4.5.jar!\com\pla\annoyingvillagers\client\particle\SparkParticle.class
